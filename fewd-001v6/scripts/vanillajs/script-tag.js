...
function generateFib(num) {
  ...
  // you'll learn about array later
  // in this course
  var result = []; 
  ...
  // however many times the `num`       // variable says to do.
  for (var i = 1; i <= num; i++) {
...
// instead of loading the entire jQuery library... 
// add an event listener to the page
// MOVED TO SCRIPT TAG IN HTML FILE!
